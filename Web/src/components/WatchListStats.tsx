...
const WatchListStats = ({ backendURL, isLoggedIn, isLoggedInCheckComplete, ratingMax }
  :
  { backendURL: string, isLoggedIn: boolean, isLoggedInCheckComplete: boolean, ratingMax: number } 
  ) => {
                      ...
                      <TreeItem nodeId="1" label="Details">
                        ...
                        <ul className="noBulletPoints">
                          {watchListSourceDtlStats
                            ?.filter((currentWatchListSourceDtlStat: typeof IWatchListSourceDtlStat, index: number) => {
                              return (
                                String(currentWatchListSourceDtlStat.WatchListSourceID) === String(currentWatchListSourceStat.WatchListSourceID) 
                                && currentWatchListSourceDtlStat.StartDate !== null
                              )
                            })
  ...
  useEffect(() => {
    if (!watchListMovieStatsLoadingStarted && !watchListMovieStatsLoadingComplete && backendURL !== "") {
      setWatchListMovieStatsLoadingStarted(true);

      axios
        .get(`${backendURL}/GetWatchListMovieStats`, { withCredentials: true })
  ...
  }, [isLoggedInCheckComplete, isLoggedIn, backendURL, watchListMovieStatsLoadingStarted, watchListMovieStatsLoadingComplete]);

  // Get WatchListSourceStats
  useEffect(() => {
    if (watchListMovieStatsLoadingComplete && !watchListSourceStatsLoadingStarted && !watchListSourceStatsLoadingComplete && backendURL !== "") {
      setWatchListSourceStatsLoadingStarted(true);

      axios
        .get(`${backendURL}/GetWatchListSourceStats`, { withCredentials: true })
  ...
  }, [isLoggedInCheckComplete, isLoggedIn, backendURL, watchListMovieStatsLoadingComplete, watchListSourceStatsLoadingStarted, watchListSourceStatsLoadingComplete]);

  // Get WatchListTopRatedStats
  useEffect(() => {
    if (watchListSourceStatsLoadingComplete && !watchListTopRatedStatsLoadingStarted && !watchListTopRatedStatsLoadingComplete && backendURL !== "") {
      setWatchListTopRatedStatsLoadingStarted(true);

      axios
        .get(`${backendURL}/GetWatchListTopRatedStats`, { withCredentials: true })
  ...
  }, [isLoggedInCheckComplete, isLoggedIn, backendURL, watchListSourceStatsLoadingComplete, watchListTopRatedStatsLoadingStarted, watchListTopRatedStatsLoadingComplete]);

  // Get WatchListTVStats
  useEffect(() => {
    if (watchListTopRatedStatsLoadingComplete && !watchListTVStatsLoadingStarted && !watchListTVStatsLoadingComplete && backendURL !== "") {
      setWatchListTVStatsLoadingStarted(true);

      axios
        .get(`${backendURL}/GetWatchListTVStats`, { withCredentials: true })
  ...
  }, [isLoggedInCheckComplete, isLoggedIn, backendURL, watchListTopRatedStatsLoadingComplete, watchListTVStatsLoadingStarted, watchListSourceStatsLoadingComplete]);

  useEffect(() => {
    if (backendURL !== "" && !watchListSourceDtlLoadingStarted && !watchListSourceDtlLoadingComplete) {
      setWatchListSourceDtlLoadingStarted(true);

      axios
        .get(`${backendURL}/GetWatchListSourceStats?GetDetail=true`)
  ...
  }, [backendURL, watchListSourceDtlLoadingStarted, watchListSourceDtlLoadingComplete]);
