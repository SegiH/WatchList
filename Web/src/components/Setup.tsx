...
const Setup = ({ backendURL, validatePassword }
  :
  { backendURL: string, validatePassword: (arg0: string) => boolean }
  ) => {
  ...
  const setupClickHandler = () => {
    ...
    axios
      .put(`${newBackendURL}/Setup?wl_username=${username}&wl_realname=${realname}&wl_password=${password}&wl_isadmin=true`, null)
