(self["webpackChunkwatchlist"] = self["webpackChunkwatchlist"] || []).push([["src_app_tabs_tabs_module_ts"],{
...
const routes = [
    {
        ...
        children: [
            {
                path: 'watchlist',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_watchlist_watchlist_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../watchlist/watchlist.module */ 8448)).then(m => m.WatchListPageModule)
            },
            {
                path: 'watchlist-items',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_watchlist-items_watchlist-items_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../watchlist-items/watchlist-items.module */ 3376)).then(m => m.WatchListItemsPageModule)
            } /*,
            {
              path: '',
