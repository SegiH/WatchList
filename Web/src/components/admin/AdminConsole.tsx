...
const AdminConsole = ({ backendURL, CancelIcon, EditIcon, generateRandomPassword, SaveIcon, setWatchListSources, setWatchListSourcesLoadingComplete, setWatchListSourcesLoadingStarted, setWatchListTypes, setWatchListTypesLoadingComplete, setWatchListTypesLoadingStarted, validatePassword, watchListSources, watchListTypes }
  : {backendURL: string, CancelIcon: typeof MuiIcon, EditIcon: typeof MuiIcon, generateRandomPassword: () => string, SaveIcon: typeof MuiIcon, setWatchListSources: (arg0: typeof IWatchListSource) => void, setWatchListSourcesLoadingComplete: (arg0: boolean) => void, setWatchListSourcesLoadingStarted: (arg0: boolean) => void, setWatchListTypes: (arg0: typeof IWatchListType) => void, setWatchListTypesLoadingComplete: (arg0: boolean) => void, setWatchListTypesLoadingStarted: (arg0: boolean) => void, validatePassword: (arg0: string) => boolean, watchListSources: typeof IWatchListSource, watchListTypes: typeof IWatchListType}
  ) => {
