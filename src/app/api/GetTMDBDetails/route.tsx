               ...
               if (urlSplit[2].toString().indexOf("imdb.com") !== -1 && urlSplit[3].toString() === "title") {
                    ...
                    try {
                         ...
                         if (detail !== null) {
                              ...
                              watchListItem.IMDBId = detail.IMDBId;
                              watchListItem.Year = detail.Year;
                              watchListItem.Released = detail.Releasedate ?? "";
                              ...
                              watchListItem.Plot = detail.Plot ?? "";
                              watchListItem.Language = detail.Language ?? "";
                              watchListItem.Country = detail.Country ?? "";
                              watchListItem.IMDB_Poster = detail.IMDB_Poster ?? "";
