...
When you add a movie or TV show, there will be a recommendations link where you can get recommendations based on the current movie/TV Show.
...
If you use Google Chrome, Watchlist can be run as a [Progressive Web Application](https://developer.mozilla.org/en-US/docs/Web/Progressive_web_apps) (PWA) where it runs on a desktop or mobile device and looks like a native application.
