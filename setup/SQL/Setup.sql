...
CREATE TABLE [dbo].[IMDBPosters](
	[IMDBPosterID] [int] IDENTITY(1,1) NOT NULL,
	[WatchListItemID] [int] NOT NULL,
	[PosterURL] [varchar](max) NOT NULL,
	[PosterData] [varbinary](max) NULL,
 CONSTRAINT [PK_IMDBPosters] PRIMARY KEY CLUSTERED 
(
	[IMDBPosterID] ASC
