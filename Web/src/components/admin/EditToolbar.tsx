...
const EditToolbar = ({ section, setRowModesModel, setIsAdding, setUsers, setWatchListSources, setWatchListTypes, users, watchListSources, watchListTypes }
  : { section: string, setRowModesModel: (arg0: typeof IUser | typeof IWatchListSource | typeof IWatchListType) => void, setIsAdding: (arg0: boolean) => void, setUsers: (arg0: typeof IUser) => void, setWatchListSources: (arg0: typeof IWatchListSource) => void, setWatchListTypes: (arg0: typeof IWatchListType) => void, users: typeof IUser, watchListSources: typeof IWatchListSource, watchListTypes: typeof IWatchListSource }) => {
  const handleClick = () => {
    let focusField = '';
    let nextID=-1;
