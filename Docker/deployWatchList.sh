#!/bin/bash 
 ...
 COMPOSE_SCRIPT=/root/secure-files/WatchList/docker-compose.yml
 CONFIG_FILE=/root/secure-files/WatchList/config/default.json
 DB_FILE=/root/docker-data/WatchListDB/watchlistdb.sqlite
