...
const Login = ({  defaultRoute, setIsLoggedIn, setActiveRoute, setIsLoggedInCheckComplete, setUserData }
  :
  {  defaultRoute: string, setIsLoggedIn: (arg0: boolean) => void, setActiveRoute: (arg0: string) => void, setIsLoggedInCheckComplete: (arg0: boolean) => void, setUserData: (arg0: typeof IUser) => void }
  ) => {
  ...
  const loginSuccessfullActions = useCallback(
    (response: typeof IUser) => {
