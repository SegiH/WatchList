...
const App = () => {
  ...
  const signOut = () => {
    axios
      .get(`${userData.BackendURL}/SignOut`)
  ...
  useEffect(() => {
    ...
    if (!watchListLoadingStarted && !watchListLoadingComplete && userData.BackendURL !== "") {
      ...
      axios
        .get(`${userData.BackendURL}/GetWatchList?SortColumn=${watchListSortColumn}&SortDirection=${watchListSortDirection}`, { withCredentials: true })
  ...
  useEffect(() => {
    ...
    if (watchListLoadingComplete && !watchListItemsLoadingStarted && !watchListItemsLoadingComplete && userData.BackendURL !== "") {
      ...
      axios
        .get(`${userData.BackendURL}/GetWatchListItems${Object.keys(watchListItemsSortColumns).includes(watchListSortColumn) ? `?SortColumn=${watchListSortColumn}&SortDirection=${watchListSortDirection}` : ``}`, { withCredentials: true })
  ...
  useEffect(() => {
    ...
    if (watchListItemsLoadingComplete && !watchListSourcesLoadingStarted && !watchListSourcesLoadingComplete && userData.BackendURL !== "") {
      ...
      axios
        .get(`${userData.BackendURL}/GetWatchListSources`, { withCredentials: true })
  ...
  useEffect(() => {
    ...
    if (watchListSourcesLoadingComplete && !watchListTypesLoadingStarted && !watchListTypesLoadingComplete && userData.BackendURL !== "") {
      ...
      axios
        .get(`${userData.BackendURL}/GetWatchListTypes`, { withCredentials: true })
  ...
  const routeList = {
    ...
    IMDBSearch: {
      ...
      RequiresAuth: true,
      Component: <IMDBSearch AddIcon={AddIconComponent} autoAdd={autoAdd} backendURL={userData.BackendURL} setNewWatchListItemDtlID={setNewWatchListItemDtlID} setWatchListItemsLoadingStarted={setWatchListItemsLoadingStarted} setWatchListItemsLoadingComplete={setWatchListItemsLoadingComplete} />,
    },
    WatchListStats: {
      Name: "WatchListStats",
      DisplayName: "Stats",
      ...
      RequiresAuth: true,
      Component: <WatchListStats backendURL={userData.BackendURL} isLoggedIn={isLoggedIn} isLoggedInCheckComplete={isLoggedInCheckComplete} ratingMax={ratingMax} />,
    },
    AdminConsole: {
      Name: "AdminConsole",
      DisplayName: "Admin",
      ...
      RequiresAuth: true,
      Component: <AdminConsole backendURL={userData.BackendURL} CancelIcon={CancelIcon} EditIcon={EditIcon} generateRandomPassword={generateRandomPassword} SaveIcon={SaveIcon} setWatchListSources={setWatchListSources} setWatchListSourcesLoadingStarted={setWatchListSourcesLoadingStarted} setWatchListSourcesLoadingComplete={setWatchListSourcesLoadingComplete} setWatchListTypes={setWatchListTypes} setWatchListTypesLoadingStarted={setWatchListTypesLoadingStarted} setWatchListTypesLoadingComplete={setWatchListTypesLoadingComplete} validatePassword={validatePassword} watchListSources={watchListSources} watchListTypes={watchListTypes} />,
    },
    Login: {
      Name: "Login",
      DisplayName: "Login",
      Path: "/Login",
      RequiresAuth: false,
      Component: <Login defaultRoute={defaultRoute} setIsLoggedIn={setIsLoggedIn} setActiveRoute={setActiveRoute} setIsLoggedInCheckComplete={setIsLoggedInCheckComplete} setUserData={setUserData} />,
    },
    Setup: {
      Name: "Setup",
      DisplayName: "Setup",
      Path: "/Setup",
      RequiresAuth: false,
      Component: <Setup backendURL={userData.BackendURL} validatePassword={validatePassword} />,
    },
  };
...
export default App;
{/*
          <span className={`menuBar ${menuVisible ? "menuBarActive" : ""}`}>
            <span>
              <span className="clickable menuHeader" onClick={toggleMenuVisible}>
                {MenuIconComponent}
              </span>
              <span className="leftMargin menuBarActiveRoute">{activeRouteDisplayName}</span>
