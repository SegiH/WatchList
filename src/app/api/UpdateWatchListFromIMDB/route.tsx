...
export async function GET(request: NextRequest) {
     ...
     if (watchListItemID === null && (confirmUpdate === null || (confirmUpdate !== null && confirmUpdate !== "true"))) {
          return Response.json(["ERROR", `If you want to update all ${wli.length} WatchListItems from IMDB, pass a parameter ConfirmUpdate=true`]);
     }
